<style>
    ...
    .bb-home-premium__heading {
        max-width: 720px;
        margin: 0 auto 36px;
        text-align: center;
    }

    .bb-home-premium__eyebrow {
    ...
    .bb-home-journey__inner {
        position: relative;
        z-index: 1;
    }

    .bb-home-journey__top {
        max-width: 660px;
        margin-bottom: 31px;
    }

    .bb-home-journey__top span {
        display: inline-block;
        margin-bottom: 9px;
        color: #d8ffe8;
        font-size: 14px;
    ...
    .bb-home-categories__all:hover,
    .bb-home-cta__button:hover {
        background: var(--bb-green-dark);
        transform: translateY(-2px);
    }

    .bb-home-category-list {
        display: flex;
        flex-wrap: wrap;
        gap: 10px;
    }
...
<section class="bb-home-premium">
    <div class="container">
        <div class="bb-home-premium__heading">
            <span class="bb-home-premium__eyebrow">{{ ($company->name ?? config('app.name')) }}-এর প্রতিশ্রুতি</span>
        ...
        <div class="bb-home-benefits">
            <article class="bb-home-benefit">
                <div class="bb-home-benefit__icon">৳</div>
        ...
        <div class="bb-home-journey">
            <div class="bb-home-journey__inner">
                <div class="bb-home-journey__top">
                ...
                <div class="bb-home-steps">
                    <div class="bb-home-step">
                        <b>০১</b>
        ...
        <div class="bb-home-categories">
            <div class="bb-home-categories__top">
                <h2>জনপ্রিয় বিভাগগুলো দেখুন</h2>
                <a href="{{ route('categories') }}" class="bb-home-categories__all">সব বিভাগ দেখুন</a>
            </div>

            <div class="bb-home-category-list">
        ...
        <div class="bb-home-cta">
            ...
            <a href="{{ route('products.index') }}" class="bb-home-cta__button">সব পণ্য দেখুন</a>
        </div>
    </div>
</section>
