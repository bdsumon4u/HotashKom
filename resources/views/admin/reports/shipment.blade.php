...
@section('title', 'Shipment & Return Report')

@section('breadcrumb-title')
    <h3>Shipment & Return Report</h3>
@endsection

@section('breadcrumb-items')
    <li class="breadcrumb-item">Reports</li>
    <li class="breadcrumb-item active">Shipment & Return</li>
@endsection

@section('breadcrumb-right')
    <div class="theme-form m-t-10 d-flex align-items-center flex-wrap" style="gap: 8px;">
...
<div class="mb-5 container-fluid">
    ...
    <div id="shipment-report-section" class="report-section mb-5">
        <div class="d-flex align-items-center justify-content-between mb-3 pb-2 border-bottom report-section-heading">
            ...
            <button type="button" class="btn btn-outline-primary btn-xs no-print" onclick="printReport('shipment')">
                <i class="fa fa-print"></i> Print Shipment
            </button>
        </div>
    ...
    <div id="return-report-section" class="report-section mb-5">
        <div class="d-flex align-items-center justify-content-between mb-3 pb-2 border-bottom report-section-heading">
            ...
            <button type="button" class="btn btn-outline-secondary btn-xs no-print" onclick="printReport('return')">
                    ...
                    <div class="p-3 card-body">
                        <div class="d-flex static-top-widget align-items-center">
                            ...
                            <div class="ml-3 flex-grow-1">
                                ...
                                <h4 class="mb-0 font-roboto font-weight-bold">{{ $returnReport['total_returned'] }}</h4>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card o-hidden h-100 kpi-card">
                    <div class="p-3 card-body">
                        <div class="d-flex static-top-widget align-items-center">
                            ...
                            <div class="ml-3 flex-grow-1">
                                <span class="font-roboto text-muted" style="font-size: 13px;">Returned</span>
                                <h4 class="mb-0 font-roboto font-weight-bold">{{ $returnReport['status_breakdown']['RETURNED']['count'] ?? 0 }}</h4>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card o-hidden h-100 kpi-card">
                    <div class="p-3 card-body">
                        <div class="d-flex static-top-widget align-items-center">
                            ...
                            <div class="ml-3 flex-grow-1">
                                <span class="font-roboto text-muted" style="font-size: 13px;">Paid Return</span>
                                <h4 class="mb-0 font-roboto font-weight-bold">{{ $returnReport['status_breakdown']['PAID_RETURN']['count'] ?? 0 }}</h4>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card o-hidden h-100 kpi-card">
                    <div class="p-3 card-body">
                        <div class="d-flex static-top-widget align-items-center">
                            ...
                            <div class="ml-3 flex-grow-1">
                                <span class="font-roboto text-muted" style="font-size: 13px;">Return Received</span>
                                <h4 class="mb-0 font-roboto font-weight-bold">{{ $returnReport['status_breakdown']['RETURN_RECEIVED']['count'] ?? 0 }}</h4>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card o-hidden h-100 kpi-card">
                    <div class="p-3 card-body">
                        <div class="d-flex static-top-widget align-items-center">
                            ...
                            <div class="ml-3 flex-grow-1">
                                <span class="font-roboto text-muted" style="font-size: 13px;">Paid Return Rcv</span>
                                <h4 class="mb-0 font-roboto font-weight-bold">{{ $returnReport['status_breakdown']['PAID_RETURN_RCV']['count'] ?? 0 }}</h4>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-3 card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    @foreach($returnReport['status_breakdown'] as $status => $data)
                                    @php
                                        $badgeClass = match($status) {
                                            'RETURNED' => 'badge-danger',
                                            'PAID_RETURN' => 'badge-info',
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $returnReport['total_returned'] > 0 ? round(($data['count'] / $returnReport['total_returned']) * 100, 1) : 0 }}%</td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
                    ...
                    <div class="p-3 card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    @foreach($returnReport['courier_breakdown'] as $courier => $data)
                                    <tr>
                                        <td>{{ $courier }}</td>
                                        <td>{{ $data['total'] }}</td>
                                        <td>{!! theMoney($data['total_purchase_cost']) !!}</td>
                    ...
                    <div class="p-3 card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    @foreach($returnReport['daily_breakdown'] as $date => $data)
                                    <tr>
                                        <td>
            ...
            <div class="col-12">
                <div class="shadow-sm rounded-0 card">
                    <div class="p-3 card-header d-flex justify-content-between align-items-center flex-wrap" style="gap: 10px;">
                        ...
                        <div class="report-status-nav">
                            @php
                                $activeReturnStatus = request('return_product_status', 'ALL');
                                $filterReturnStatuses = [
                                    'ALL' => ['label' => 'ALL', 'class' => 'status-pill-all', 'count' => $returnReport['total_returned']],
                                    'RETURNED' => ['label' => 'Returned', 'class' => 'status-pill-returned', 'count' => $returnReport['status_breakdown']['RETURNED']['count'] ?? 0],
                                    'PAID_RETURN' => ['label' => 'Paid Return', 'class' => 'status-pill-paid-return', 'count' => $returnReport['status_breakdown']['PAID_RETURN']['count'] ?? 0],
                                    'RETURN_RECEIVED' => ['label' => 'Return Received', 'class' => 'status-pill-return-rcv', 'count' => $returnReport['status_breakdown']['RETURN_RECEIVED']['count'] ?? 0],
                                    'PAID_RETURN_RCV' => ['label' => 'Paid Return Rcv', 'class' => 'status-pill-paid-return-rcv', 'count' => $returnReport['status_breakdown']['PAID_RETURN_RCV']['count'] ?? 0],
                                ];
                            @endphp
                            ...
                            @foreach($filterReturnStatuses as $statusKey => $statusConfig)
                                ...
                                @endphp
                                <a href="{{ route('admin.reports.shipment', array_merge(request()->query(), ['return_product_status' => $statusKey])) }}"
                                   class="status-pill {{ $statusConfig['class'] }} {{ $isActive ? 'active' : '' }}">
                                    <span class="status-pill-label">{{ $statusConfig['label'] }}</span>
                                    <span class="status-pill-count">{{ $statusConfig['count'] }}</span>
                                </a>
...
@push('css')
    ...
    <style>
        ...
        @media print {
            ...
            body.print-shipment-only #return-report-section {
                display: none !important;
            }

            body.print-return-only #shipment-report-section {
                display: none !important;
            }

            body.print-shipment-only #print-shipment-header {
                display: block !important;
            }

            body.print-return-only #print-return-header {
                display: block !important;
            }
            ...
            /* Hide DataTable interactive controls */
            .dt-buttons,
            .dataTables_paginate,
            .dataTables_info,
            .dataTables_filter,
            ...
            /* Remove distracting horizontal lines */
            hr,
            .hr,
            [class*="border-top"],
            .border-top {
...
@push('js')
    ...
    <script>
        ...
        function printReport(type) {
            $('body').removeClass('print-shipment-only print-return-only');

            if (type === 'shipment') {
                $('body').addClass('print-shipment-only');
            } else if (type === 'return') {
                $('body').addClass('print-return-only');
            }
