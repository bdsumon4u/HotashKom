                                    ...
                                    <tr class="border border-danger">
                                        ...
                                        <td>
                                            @foreach (unserialize($cart->content) as $product)
                                                <div class="dropcart__product d-flex" data-id="{{ $product->id }}"
                                                    style="gap: .5rem;">
                                                    <div class="dropcart__product-image">
                                                        <a href="{{ route('products.show', $product->options->slug ?? 'not-found') }}"
                                                            target="_blank">
                                                    ...
                                                    <div class="dropcart__product-info">
                                                        <div class="dropcart__product-name">
                                                            <a
                                                                href="{{ route('products.show', $product->options->slug ?? 'not-found') }}">{{ $product->name }}</a>
                                                        </div>
                                                        <div class="dropcart__product-meta">
                                                            <span
                                                                class="dropcart__product-quantity">{{ $product->qty }}</span>
                                                            x <span class="dropcart__product-price">TK
                                                                {{ $product->price }}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <td width="50">
                                            <x-form action="{{ route('admin.carts.destroy', $cart->identifier) }}"
                                                method="delete">
