<div class="row">
    ...
    <div class="col-12">
        <div class="py-5 text-center text-danger"><h4>{{session('error')}}</h4></div>
    </div>
    @else
    <div class="pr-1 col-12 col-md-8">
        <div class="card mb-lg-0">
            ...
            <div class="card-body d-md-none">
                ...
                <button type="button" wire:click="checkout" wire:loading.attr="disabled" class="text-white btn btn-primary btn-xl btn-block">কনফার্ম অর্ডার</button>
            </div>
