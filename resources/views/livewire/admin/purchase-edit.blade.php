    ...
    <form wire:submit.prevent="save">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card shadow-sm border mb-3" style="background: #ffffff;">
                    <div class="card-header p-3 bg-light border-bottom">
                        <h6 class="mb-0 font-weight-bold text-dark"><i class="fa fa-credit-card text-success mr-2"></i> Payment & Balance</h6>
                    </div>
                    <div class="card-body p-3">
                        <div class="form-row">
                            <div class="form-group col-md-6">
        ...
        <div class="d-flex justify-content-end">
            ...
            <button type="submit" class="btn btn-primary px-4"><i class="fa fa-save mr-1"></i> Update Purchase</button>
        </div>
    </form>
</div>
