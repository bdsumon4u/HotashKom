...
<body class="header-fixed has-mobile-bottom-navbar" style="margin: 0; padding: 0;">
    ...
    <div id="mobile-menu-wrapper" class="mobile-menu-wrapper">
        <div class="mobile-menu-header"> <a class="customer-signinup" href="https://maroonedbd.com/?page_id=20">Login
                &amp; Signup</a></div>
        ...
        <div class="mobile-topbar">
            <div class="kapee-social icons-default icons-shape-circle icons-size-default "> <a
                    href="https://www.facebook.com/marooned.mr/" rel="external" target="_blank"
                    class="social-facebook"><i class="fa fa-facebook"></i> <span
                        class="social-text">Facebook</span></a><a href="#" rel="external" target="_blank"
                    class="social-twitter"><i class="fa fa-twitter"></i> <span
                        class="social-text">Twitter</span></a><a href="#" rel="external" target="_blank"
                    class="social-linkedin"><i class="fa fa-linkedin"></i> <span
                        class="social-text">LinkedIn</span></a><a href="https://www.instagram.com/marooned.mr/"
                    rel="external" target="_blank" class="social-instagram"><i class="fa fa-instagram"></i>
                    <span class="social-text">Instagram</span></a><a href="#" rel="external" target="_blank"
                    class="social-flickr"><i class="fa fa-flickr"></i> <span class="social-text">Flickr</span></a><a
                    href="#" rel="external" target="_blank" class="social-rss"><i class="fa fa-rss"></i>
                    <span class="social-text">RSS</span></a><a href="#" rel="external" target="_blank"
                    class="social-youtube"><i class="fa fa-youtube"></i> <span class="social-text">Youtube</span></a>
            </div>
        </div>
    </div>
            ...
            <div class="chaty-channels">
                <div class="chaty-channel-list">
                    <div class="chaty-channel Phone-channel" id="Phone-0-channel" data-id="Phone-0" data-widget="0"
                        data-channel="Phone"><a href="tel:+8801893981988" target=""
                    ...
                    <div class="chaty-channel Facebook_Messenger-channel" id="Facebook_Messenger-0-channel"
                        data-id="Facebook_Messenger-0" data-widget="0" data-channel="Facebook_Messenger"><a
                            href="https://m.me/marooned.mr" target="" class="chaty-tooltip pos-left"
                    ...
                    <div class="chaty-channel Whatsapp-channel" id="Whatsapp-0-channel" data-id="Whatsapp-0"
                        data-widget="0" data-channel="Whatsapp"><a href="javascript:;" target=""
